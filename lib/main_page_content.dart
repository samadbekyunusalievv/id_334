...
Auction houses are a place where property or any kind of objects are sold to anyone who bids the highest. Now there are different kinds of auctions that are held amongst all of them there are Art auctions. In art auctions, different types of exclusive artworks are on sale, and whoever places the highest bid can take the artwork into their possession. They are basically public events where anyone can participate. In an Art Auction, any type of art can be sold but paintings are the most common. Now, one cannot hold an art auction without knowing anything about it, it needs lots of work and patience. In this article, we will talk about how Art Auction actually works in real. So, let’s get started with our business.
''';

const String whatIsAuctionText = '''
An auction is nothing but a sales event where buying and selling of products and services happen through bidding. People compete with each other to get hold of the item of their choice. To secure the item one has to bid higher than the previous bidder, the price increases with each bid until no one else is willing to bid more than the current price. For example, if the last bid is \$50,000 and no one is willing to bid for \$50,500, the item will go to the buyer with the highest bid. In an auction, one can find various objects like antique pieces, rare objects, properties, company or some artworks that include painting and others. In every auction house, there is a team of specialists who sets the prices for the items that are going to be used for auctions.
''';

const String historyOfAuctionsText = '''
The exact process of Auction came into existence around 500 B.C. At that time, women were sold in Greece for marriage by using the method of auction. Then in the United States, various properties, agricultural products, and slaves were used to get sold through this method. With time, artworks, properties, and rare objects are sold to people. Thanks to the help of modern technology, computers, and cell phones can be used for bidding in auctions. Not only that, but we also have various online auction sites like eBay where people can bid to acquire their favourite items.
''';
...
This is the most common type of auction. It is an open auction where the participants compete with each other by bidding higher than the other buyers to secure the item for themselves. The prices of the items are stated by the hosts and then the bidding starts, the participants call out the bids and it continues till no one is willing to bid higher than the last bid. The item goes to the person who is the highest and the final bidder. This auction is common while selling wine, artworks, tobacco, or any kind of antique product.
''';
